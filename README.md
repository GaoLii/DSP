...
# Pretrained models
- [Pretrained model for GTA5->Cityscapes](https://note.youdao.com/): Peaked at xxx mIoU.

- [Pretrained model for SYN->Cityscapes](https://note.youdao.com/): Peaked at xxx mIoU.

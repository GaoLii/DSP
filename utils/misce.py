...
class rand_mixer():
    def __init__(self, root, dataset):
        if dataset == "gta":
            ...
            self.data_aug = Compose([RandomCrop_gta(self.input_size)])
    ...
    def mix(self, in_img, in_lbl, one_mask, classes, weight=1.0):
        ...
        for i in classes:
            ...
            mixtarget = torch.cat((lbl.unsqueeze(0), in_lbl))
        ...
        return in_img, in_lbl, one_mask.unsqueeze(0)

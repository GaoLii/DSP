...
class SynthiaDataSet(data.Dataset):
    def __init__(self, root, list_path, max_iters=None, augmentations = None, img_size=(321, 321), mean=(128,128,128), scale=True, mirror=True, ignore_label=255):
        self.root = root
    ...
    def __getitem__(self, index):
        ...
        label = np.asarray(imageio.imread(osp.join(self.root, "GT/LABELS/%s" % name), format='PNG-FI'))[:,:,0]  # uint16
